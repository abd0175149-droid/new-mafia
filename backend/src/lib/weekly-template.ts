...
/**
 * بدايةُ أسبوعٍ يحوي `ref` — أحدُ ذلك الأسبوع عند منتصف ليله بتوقيت عمّان.
 *
 * 🔴 يُحسب على التقويم المدنيّ لعمّان لا على UTC: ليلةُ الجمعة تمتدّ إلى ما بعد
...
export function weekStartAmman(ref: Date = new Date()): Date {
  ...
  return new Date(civil - dow * 86_400_000);
}
