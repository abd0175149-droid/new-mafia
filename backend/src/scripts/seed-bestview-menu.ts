...
//    نكهات مزايا مجموعةٌ اختياريّة (من اختار نخلة لا يختار نكهة مزايا).
//
...
const SPEC: MenuSpec = {
  sharedGroups: [
    // 💨 المعسّل — الفرق يمرّ عبر الباقات: نخلة/Love +1.00 على أيّ عرض
    { key: 'molasses', name: 'المعسّل', isRequired: true, values: [
      { name: 'مزايا' },
      { name: 'نخلة تفاحتين', priceDelta: 1 },
      { name: 'بيت فيو Love', priceDelta: 1 },
    ] },
    // نكهات مزايا — افتراضيّة، تُبدَّل من كونسول المكان
    { key: 'mazayaFlavor', name: 'نكهة مزايا', isRequired: false, values: [
      { name: 'تفاحتين' }, { name: 'عنب ونعنع' }, { name: 'ليمون ونعنع' },
      { name: 'بطيخ ونعنع' }, { name: 'علكة وقرفة' }, { name: 'عنب' }, { name: 'زغلول' },
    ] },
    ...
    { key: 'latte', name: 'نكهة اللاتيه', isRequired: false, values: [
  ...
  sections: [
    // ══ 💨 الأراجيل ══
    { name: 'أراجيل', items: [
      { name: 'أرجيلة', price: 3, groups: ['molasses', 'mazayaFlavor'],
