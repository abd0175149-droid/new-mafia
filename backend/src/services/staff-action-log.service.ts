...
export const ACTION_CATALOG: Record<string, { category: string; labelAr: string }> = {
  ...
  'day:start-discussion': { category: 'GAME_FLOW', labelAr: 'بدء النقاش' },
  'day:next-speaker': { category: 'GAME_FLOW', labelAr: 'المتحدث التالي' },
  'day:prev-speaker': { category: 'GAME_FLOW', labelAr: 'المتحدث السابق' },
  // ── المؤقّتات ──
  'day:start-justification-timer': { category: 'TIMER', labelAr: 'بدء مؤقّت التبرير' },
  'day:stop-justification-timer': { category: 'TIMER', labelAr: 'إيقاف مؤقّت التبرير' },
  'day:reset-justification-timer': { category: 'TIMER', labelAr: 'إعادة مؤقّت التبرير' },
  'day:adjust-timer': { category: 'TIMER', labelAr: 'ضبط المؤقّت' },
  'day:timer-action': { category: 'TIMER', labelAr: 'إجراء على المؤقّت' },
  ...
  'night:display-event': { category: 'GAME_FLOW', labelAr: 'عرض حدث ليلي على الشاشة' },
  'game:transition-phase': { category: 'GAME_FLOW', labelAr: 'نقل مرحلة اللعبة يدوياً' },
  // ── توزيع الأدوار (إعداد اللعبة) ──
  'room:start-generation': { category: 'ROLE_SETUP', labelAr: 'بدء توليد الأدوار' },
  'setup:roles-confirmed': { category: 'ROLE_SETUP', labelAr: 'اعتماد إعداد الأدوار' },
  'setup:bind-role': { category: 'ROLE_SETUP', labelAr: 'ربط دور بلاعب' },
  'setup:unbind-role': { category: 'ROLE_SETUP', labelAr: 'فكّ ربط دور' },
  'setup:random-assign': { category: 'ROLE_SETUP', labelAr: 'توزيع أدوار عشوائي' },
  'setup:confirm-roles': { category: 'ROLE_SETUP', labelAr: 'تأكيد الأدوار (بدء اللعبة)' },
  'setup:binding-complete': { category: 'ROLE_SETUP', labelAr: 'اكتمال ربط الأدوار' },
  // ── المقاعد/اللاعبون ──
  ...
  'room:freeze-player': { category: 'PLAYER', labelAr: 'تجميد لاعب' },
  'room:player-exit': { category: 'PLAYER', labelAr: 'إخراج لاعب من الغرفة' },
  ...
  'room:toggle-dynamic-engine': { category: 'ROOM_CONFIG', labelAr: 'تبديل المحرك الديناميكي' },
  // ── تدفّق اللعبة ──
  ...
  // ── دورة حياة الغرفة ──
  'room:close-event': { category: 'ROOM_LIFECYCLE', labelAr: 'إنهاء الفعالية' },
  'room:close': { category: 'ROOM_LIFECYCLE', labelAr: 'إغلاق الغرفة' },
  'room:delete-room': { category: 'ROOM_LIFECYCLE', labelAr: 'حذف الغرفة' },
  // ── السحب العشوائي ──
...
export const CATEGORY_LABELS: Record<string, string> = {
  ...
  ROLE_SETUP: 'توزيع الأدوار',
  ROOM_CONFIG: 'إعدادات الغرفة',
  ROOM_LIFECYCLE: 'دورة حياة الغرفة',
