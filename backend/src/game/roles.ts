...
// 🔴 الترتيبُ يُقدّم عديمَ القدرة: مَن لا قدرةَ ليليّة له يرث الاغتيال أوّلاً، فلا
//    يجتمع في يدِ لاعبٍ واحدٍ فعلان في ليلةٍ واحدة إلّا اضطراراً. الحرباية والمافيا
//    العاديّ لا يحملان شيئاً (تمويهُ الحرباية سلبيّ)، والأخُ الأكبر يملك الاغتيال
//    أصلاً فوراثتُه لا تضيف له فعلاً. ويبقى القصُّ والساحرةُ آخِراً لأنّهما وحدهما
//    مَن يُنتج ازدواجاً (إسكاتٌ + اغتيال · تعطيلٌ + اغتيال).
//    الازدواجُ لا يُلغى تماماً — لو لم يبقَ إلّا الساحرةُ وجب أن تقتل وتعطّل — لكنّه
//    يصير آخرَ الاحتمالات بدل أن يكون ثالثَها.
export const MAFIA_KILL_PRIORITY: Role[] = [
  Role.GODFATHER,
  Role.CHAMELEON,     // بلا قدرةٍ ليليّة — وارثٌ نظيف
  Role.MAFIA_REGULAR, // بلا قدرةٍ ليليّة — وارثٌ نظيف
  Role.OLDER_BROTHER, // 👥 يملك الاغتيال أصلاً — لا يزدوج
  Role.SILENCER,      // ⚠️ إسكاتٌ + اغتيال
  Role.WITCH,         // ⚠️ تعطيلٌ + اغتيال — آخرُ الاحتمالات
];
