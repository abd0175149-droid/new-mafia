...
}
{
  ...
  const slots = bindRoomSchedule(PLAN, [], DATE, at(18, 0));
  check('بلا مباريات: الشرائح على أوقات الخطّة', slots[0].projectedStart === at(19, 45) && slots[1].projectedStart === at(21, 20));
}
