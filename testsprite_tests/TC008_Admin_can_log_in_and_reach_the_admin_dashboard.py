...
async def run_test():
    ...
    try:
        ...
        # -> Navigate directly to /admin/login (http://localhost:3000/admin/login) to reach the admin login form.
        await page.goto("http://localhost:3000/admin/login")
        
        # -> Fill the username and password fields with admin/admin123, then submit the login form.
        frame = context.pages[-1]
        # Input text
