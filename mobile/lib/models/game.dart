...
enum GameStep {
  ...
  /// 👁️ وصل واللعبةُ جارية: يجلس في الحلقة على مقعدٍ محجوز ويشاهد،
  /// ويُرقَّى لاعباً تلقائيّاً عند اللعبة التالية. لا دور ولا تصويت ولا ليل.
  spectating;

  /// كلتاهما تعرضان شاشة اللعب، ومعظم المؤثّرات مقيّدة بهما.
  bool get inGame => this == GameStep.done || this == GameStep.rejoined;

  /// الخطواتُ التي تستدعي استطلاعَ الحالة (المتفرّج يستطلع أيضاً كي يُرقَّى).
  bool get polls => inGame || this == GameStep.spectating;
}
