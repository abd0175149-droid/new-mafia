        ...
        child: Column(
          ...
          children: [
            ...
            ...const [
              ...
              // 🔴 كان هنا «نحفظ آخر نقطةٍ فقط — لا سجلّ تحرّكات»، وصار كذباً
              //    يوم شُحن تاريخُ المواقع. ادّعاءُ خصوصيّةٍ خاطئ أمام كلّ لاعب
              //    أسوأُ من غيابه. النصُّ نفسُه في LocationGate.tsx — يتغيّران معاً.
