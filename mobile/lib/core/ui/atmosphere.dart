...
class DisplayBg extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // وهجٌ سفليّ خافت خلف الشريط الزجاجيّ — **على المنصّتين معاً**.
    //
    ...
    //
    // كان محصوراً في iOS؛ عُمّم بقرار المالك (95 §4-ق1/ق2): تدرّجاتٌ
    // صرفة بلا أيّ blur، كلفتها لا تُقاس حتى على تابلتات النادي — وهي
    // وحدها ما ينقل أندرويد من «لوحٍ أسود» إلى لغة النوار الموحّدة.
    // (كسرُ تكافؤ الويب الموثَّق في 11 §4.6 صار يشمل المنصّتين عمداً.)
    //
