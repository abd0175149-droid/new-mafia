...
> **الحالة قبلك:** طبقات مكافحة الغش الثلاث الأولى **مبنيّةٌ ومنشورة** (كوميت
> `fbf07f1`): الخادم (`cheat_signals` + بثّ الليدر)، وأندرويد (`FLAG_SECURE`)،
> والتطبيق/الويب (علامة مائيّة + تتبّع الغياب). **الناقص iOS الأصليّ وحده** —
> وهو ما يُنفَّذ من الـMac. الجانب Dart جاهزٌ وينتظر القناة الأصليّة.
