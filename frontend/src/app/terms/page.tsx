...
// ══════════════════════════════════════════════════════
// 📜 صفحةُ شروط الاستخدام — عامّةٌ بلا مصادقة
//
...
export default function TermsPage() {
  const { doc, loading, error } = usePolicyDoc('terms');
    ...
    <div className="min-h-screen bg-[#050505] py-10 px-5" dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-10 pt-6 flex flex-wrap gap-4 text-[13px]"
          ...
          <Link href="/privacy" className="text-amber-400 hover:underline">سياسة الخصوصيّة ←</Link>
