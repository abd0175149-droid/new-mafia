...
const EVENT_META: Record<string, { icon: string; title: string; color: string; displayable: boolean }> = {
  ...
  // 🕵️ مَن سأل عنه الشريفُ يخرج معه — يُعرض في القاعة: خروجٌ حقيقيّ لا معلومة سرّيّة
  SHERIFF_REVENGE:      { icon: '🕵️', title: 'ثأر الشريف',        color: 'text-[#C5A059]', displayable: true },
  ...
  // 🔥 نهوضُ العنقاء — للموجّه وحده: يعرف لماذا لم يمت أحد، والقاعةُ ترى
  //    الاحتراقَ ولا تعرف على مَن وقعت المحاولة. عرضُه كان يكشف مقعدَ العنقاء.
  PHOENIX_REBIRTH:      { icon: '🔥', title: 'العنقاء نهض من رماده', color: 'text-[#fb923c]', displayable: false },
